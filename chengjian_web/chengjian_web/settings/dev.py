"""
Django settings for chengjian_web project.
...
SECRET_KEY = 'qadkhp1u9$fzrgu9ll-mbf9j7u75-ypi%sw^^fn#fsyx#v(1*b'
...
ROOT_URLCONF = 'chengjian_web.urls'
...
WSGI_APPLICATION = 'chengjian_web.wsgi.application'
